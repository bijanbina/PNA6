...
source /mnt/hdd2/Petalinux/fft_zc702_linux/project-spec/hw-description/ps7_init.tcl; ps7_post_config
catch {stop}
...
dow "/mnt/hdd2/Petalinux/fft_zc702_linux/pre-built/linux/images/zynq_fsbl.elf"
after 2000
con
after 3000; stop
targets -set -nocase -filter {name =~ "arm*#0"}
...
dow "/mnt/hdd2/Petalinux/fft_zc702_linux/pre-built/linux/images/u-boot.elf"
after 2000
con
after 2000; stop
targets -set -nocase -filter {name =~ "arm*#0"}
...
dow -data "/mnt/hdd2/Petalinux/fft_zc702_linux/pre-built/linux/images/system.dtb" 0x08008000
after 2000
rwr r2 0x08008000
targets -set -nocase -filter {name =~ "arm*#0"}
# dow -data "/group/bcapps/seemas/cases/10348699/Xilinx-ZC702-2016.1/pre-built/linux/images/zImage" 0x00008000
dow -data "/mnt/hdd2/Petalinux/fft_zc702_linux/pre-built/linux/images/zImage" 0x00008000
after 2000
rwr pc 0x00008000
con
after 5000
# fpga "/group/bcapps/seemas/cases/10348699/Xilinx-ZC702-2016.1/pre-built/linux/implementation/download.bit"
fpga "/mnt/hdd2/Petalinux/fft_zc702_linux/pre-built/linux/implementation/system.bit"
after 2000
exit
