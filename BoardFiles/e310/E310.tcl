...
proc getPresetInfo  {} {
	return [dict create  name E310  display_name  {E310}   description  {E310 board preset}  vlnv  xilinx.com:ip:processing_system7:5.5]
}
...
proc apply_preset {IPINST} {
	...
	if { $c_board != "e310" } {
	  send_msg_id PS7-6 WARNING "The applied preset does not match with $c_board board preset. You may not get expected settings for $c_board board. The ZedBoard preset is designed for ZedBoard board." -verbose
	}
 [namespace parent]::Check_for_unbonded_pins $IPINST "E310"
 return [dict create \
