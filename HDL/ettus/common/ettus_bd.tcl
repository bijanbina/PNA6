...
# SD Write Protected GND
ad_ip_instance xlconstant sd_wp_gnd
ad_ip_parameter sd_wp_gnd CONFIG.CONST_WIDTH 1
ad_ip_parameter sd_wp_gnd CONFIG.CONST_VAL 0
ad_connect sd_wp_gnd/dout sys_ps7/SDIO0_WP
